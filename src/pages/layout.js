            ...
            {open ? (
              ...
              >
                <li className="menu-item">
                 <Link to="/Server1"  onClick={()=>dispatch(changeServer(0))}>
                  <p className="mangainn">mangainn.net</p>
                 </Link>
                </li>
                <li className="menu-item">  
                <Link to="/Server2" onClick={()=>dispatch(changeServer(4))}> {/* recdirect to server novel : bestlightnovel.om*/}
                  <p className="manganelo">ww5.manganelo.tv</p>
                </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server3" onClick={() => dispatch(changeServer(7))}>
                  <p className="readm">readm.org</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server4" onClick={() => dispatch(changeServer(2))}>
                     <p className="mangareader"> mangareader.cc</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server5" onClick={() => dispatch(changeServer(6))}>
                  <p className="mangakomi"> mangakomi.io</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server6" onClick={() => dispatch(changeServer(8))}>
                  <p className="mangajar">mangajar.com</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server7" onClick={() => dispatch(changeServer(5))}>
                  <p className="mangajar.com"> mangajar.com/manga</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server8" onClick={() => dispatch(changeServer(18))}>
                  <p className="it.ninemanga"> it.ninemanga.com</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server9" onClick={() => dispatch(changeServer(17))}>
                  <p className="fr.ninemanga"> fr.ninemanga.com</p>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to="/Server10" onClick={() => dispatch(changeServer(16))}>
                  <p className="es.ninemanga">es.ninemanga.com</p>
                  </Link>
                </li>
              </ul>
            ) : null}
